...
public final class ETHMnemonic {
    public enum Strength: Int {
        case normal = 128
        case hight = 256
    }
    
    public static func create(strength: Strength = .normal, language: Mnemonic.Language = .english) -> [String] {
    ...
    public static func create(entropy: Data, language: Mnemonic.Language = .english) -> [String] {
        ...
        let words = Mnemonic.wordList(for: language)
    ...
    public static func createSeed(mnemonic: [String], withPassphrase passphrase: String = "") throws -> Data {
        ...
        return ETHCrypto.PBKDF2SHA512(password, salt: salt)
    }
}
